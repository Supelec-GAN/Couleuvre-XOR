...
public:
	...
	/// Fonction appliquant la méthode de rétropropagation stochastique sur mNetwork
	/**
	 ...
	 */
	void            onlineBackProp(Eigen::VectorXf input, Eigen::VectorXf desiredOutput, float step = 0.2, float dx = 0.05);
...
private:
	 ...
	 * @param step le pas d'apprentissage
	 */
	void            onlinePropError(Eigen::VectorXf xnPartialDerivative, float step);
